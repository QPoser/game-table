...
final class AppAuthenticator extends AbstractFormLoginAuthenticator implements PasswordAuthenticatedInterface
{
    use TargetPathTrait;
    ...
    {
        return $this->urlGenerator->generate('app.profile');
    }
